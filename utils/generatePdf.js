...
pdfMake.fonts = {
  ...
  BarcodeFont: {
    normal: 'code128.ttf',
    bold: 'code128_L.ttf',
    italics: 'code128_XL.ttf',
    bolditalics: 'BarcodeFont-MediumItalic.ttf',
  },
}

const generatePdf = (light = true) =>
  new Promise(resolve => {
    // console.warn(Object.keys(this.pdfMake.vfs))
    pdfmake
    ...
    const docDefinition = {
      ...
      content: [
        ...examples.columnsContent(light),
        ...examples.layout(light),
        ...examples.lists(light),
        ...examples.link(light),
        ...examples.qr(light),
        ...examples.barCode(light),
